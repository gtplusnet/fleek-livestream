 ...
 */
package com.live.broadcast.plugin.liveVideoPlayer.flvExtractor;
...
/* package */ final class AudioTagPayloadReader extends TagPayloadReader {
  ...
  protected void parsePayload(ParsableByteArray data, long timeUs) {
    ...
    if (packetType == AAC_PACKET_TYPE_SEQUENCE_HEADER && !hasOutputFormat) {
      ...
      Pair<Integer, Integer> audioParams = null;
      try {
        audioParams = CodecSpecificDataUtil.parseAacAudioSpecificConfig(
            audioSpecificConfig);
